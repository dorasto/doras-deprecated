    ...
    return (
        <section className="mx-auto text-surface-800">
            <div className="mb-4 grid grid-cols-12 gap-4">
                <BounceCard href="#features" className="col-span-12 row-span-2 bg-gradient-to-tl from-violet-400 via-pink-300 to-lime-300 shadow-lg md:col-span-8">
                    ...
                    <div className="duration-[250ms] absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-transparent p-4 transition-transform group-hover:translate-y-4 group-hover:rotate-[2deg]">
                        <span className="block text-center font-semibold text-indigo-50">
                            <WindowMockup user={user} />
                        </span>
                    </div>
                </BounceCard>
                <BounceCard href="#features" className="col-span-12 bg-gradient-to-br from-rose-400 to-orange-300 shadow-lg md:col-span-4">
                ...
                <BounceCard href="#features" className="col-span-12 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-cyan-200 via-orange-200 to-yellow-300 shadow-lg md:col-span-4">
            ...
            <div className="grid grid-cols-12 gap-4">
                <BounceCard href="#features" className="col-span-12 bg-gradient-to-r from-teal-200 to-lime-200 shadow-lg md:col-span-8">
                ...
                <BounceCard href="#features" className="col-span-12 bg-gradient-to-br from-green-400 to-emerald-400 shadow-lg md:col-span-4">
...
const CardDescription = ({ children }: { children: ReactNode }) => {
    return <h3 className="mx-auto max-w-md text-center text-xl font-semibold">{children}</h3>;
};
