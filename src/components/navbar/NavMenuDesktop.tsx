                        ...
                        <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                            <li className="row-span-3">
                                <NavigationMenuLink asChild>
                                    <a className="from-muted/50 to-muted flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b p-6 no-underline outline-none focus:shadow-md" href="#pricing">
                                        <Crown className="text-accent mb-2 h-12 w-12" />
                                        <div className="mb-2 text-lg font-black">Doras Pro</div>
                                        <p className="text-muted-foreground text-sm font-bold leading-tight">The Ultimate tools for the Ultimate users</p>
                                    </a>
                                </NavigationMenuLink>
                            </li>
...
const ListItem = React.forwardRef<React.ElementRef<"a">, React.ComponentPropsWithoutRef<"a">>(({ className, title, children, ...props }, ref) => {
    return (
        <li>
            <NavigationMenuLink asChild>
                <a ref={ref} className={cn("focus:bg-accent block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary-400 hover:text-white focus:text-white", className)} {...props}>
